...
android_src="${app_root}/android/firebase/${flavor}/google-services.json"
android_dst="${app_root}/android/app/src/${flavor}/google-services.json"
ios_src="${app_root}/ios/firebase/${flavor}/GoogleService-Info.plist"
